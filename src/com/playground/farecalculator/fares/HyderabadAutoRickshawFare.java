 ...
 *
 */
public class HyderabadAutoRickshawFare implements IFare
{

	public static final int INITIAL_TICKS = 16;
	...
	public static final int WAIT_TIME_FOR_TICK = 192;
	public static final int WAIT_TIME_FOR_TICK_BEFORE_FIRST_TICK = 192;
	public static final int WAIT_TIME_CONCESSION = 0; //0 minutes
	public static final double TICKS_MULTIPLICATION_FACTOR = 0.8;
	public static final double CONSTANT_FACTOR = 1.2;
